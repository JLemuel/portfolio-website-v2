...
function SkillIcon({
  ...
  return (
    <div className="group flex flex-col items-center gap-2 rounded-xl p-2 transition hover:bg-indigo-50/50 dark:hover:bg-indigo-500/10">
      <Icon className="h-8 w-8 text-zinc-600 transition-colors group-hover:text-indigo-500 dark:text-zinc-400 dark:group-hover:text-indigo-400" />
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        <div className="lg:pl-20">
          <div className="relative max-w-xs px-2.5 lg:max-w-none">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute -inset-4 rounded-3xl bg-gradient-to-br from-indigo-500/20 via-violet-500/10 to-fuchsia-500/20 blur-2xl"
            />
            <Image
              src={portraitImage}
              alt="John Lemuel"
              sizes="(min-width: 1024px) 32rem, 20rem"
              className="relative aspect-square rotate-3 rounded-2xl bg-zinc-100 object-cover ring-1 ring-zinc-900/5 dark:bg-zinc-800 dark:ring-white/10"
            />
          </div>
        </div>

        <div className="lg:order-first lg:row-span-2">
          <span className="inline-flex items-center gap-2 rounded-full border border-zinc-200/80 bg-white/70 px-3 py-1 text-xs font-medium text-zinc-700 backdrop-blur dark:border-zinc-700/60 dark:bg-zinc-900/60 dark:text-zinc-300">

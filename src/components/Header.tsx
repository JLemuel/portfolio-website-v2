  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-indigo-500/0 via-indigo-500/60 to-fuchsia-500/0 dark:from-indigo-400/0 dark:via-indigo-400/60 dark:to-fuchsia-400/0" />
        )}
      </Link>
    </li>
  )
